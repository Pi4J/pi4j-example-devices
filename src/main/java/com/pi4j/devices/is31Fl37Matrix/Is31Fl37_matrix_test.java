...
public class Is31Fl37_matrix_test {
        ...
        public Is31Fl37_matrix_test() {
            System.out.println(" default ctor");
        }

        public Is31Fl37_matrix_test(Context pi4j, Console console, int bus, int address, int bmpBus, int bmp_address, int loop_count, int repeat_count, int led_blink,
        ...
        public static void main(String[] args) throws IOException, InterruptedException {
            ...
            console.println("Is31Fl37_matrix_test entered   :  ");
            String badParm = "";
            ...
            com.pi4j.devices.is31Fl37Matrix.Is31Fl37_matrix_test display_app = new com.pi4j.devices.is31Fl37Matrix.Is31Fl37_matrix_test(pi4j,console, bus_num, address, bmp_bus, bmp_address, loop_count,
