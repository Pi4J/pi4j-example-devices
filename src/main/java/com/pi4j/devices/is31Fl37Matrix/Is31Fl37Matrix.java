...
public class Is31Fl37Matrix {
    ...
    /**
     * Ti avoid a Pi4J_V2 GPIO interrupt bug, manually check the interrupt GPIO to determine if
     * the matrix controller signaled frame display completion via the INTB line
     *
     * @return Class containing completion success and loop count waiting for interrupt.
     */
