...
public class NeoPixel94V extends Component {
    ...
    private int dataPinNum = 0x21;
    private DigitalOutputConfigBuilder outputConfig1;
    private DigitalOutput dataOut = null;

    PixelColor pixel;
    private int LED_RESET_uS =   55;
    private int highTime0NanoSeconds = 400;         // 0.4 us
    private int lowTime0NanoSeconds = 850;          // 0.85 Us
    private int highTime1NanoSeconds = 800;         // 0.8 us
    private int lowTime1NanoSeconds = 450;          // 0.45 us
    ...
    void init() {
        ...
        this.dataOut = this.context.create(this.outputConfig1);
    ...
    int waitForInput(){
        ...
        private boolean doReset(){
            this.logger.debug(">>> Enter  doReset");
            boolean rval = false;
            long now = System.nanoTime();
            while (System.nanoTime() - now < this.LED_RESET_uS*1000) ;

            this.logger.debug("<<< Exit doReset");
            return(rval);
        }
