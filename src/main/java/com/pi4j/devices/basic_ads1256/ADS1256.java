...
public class ADS1256 {
     ...
     */
    public ADS1256(Context pi4j, SpiBus spiBus, int chipSelect, boolean reset, int drdyPin, int csPin, int rstPin, boolean crtRstGpio, int pdwnPin, boolean crtPdwnGpio, Console console, String traceLevel, double vref) throws InterruptedException {
        super();
    ...
    private void init() throws InterruptedException {
        ...
        var inputConfig1 = DigitalInput.newConfigBuilder(pi4j)
            .id("DRDY_pin")
            .name("DRDY")
            .bcm(this.drdyPinNum); //               .pull(PullResistance.PULL_UP)
        try {
