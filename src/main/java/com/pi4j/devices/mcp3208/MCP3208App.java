...
package com.pi4j.devices.mcp3208;

import com.pi4j.Pi4J;
import com.pi4j.context.Context;
import com.pi4j.drivers.io.ad.mcp300x.Mcp3208Driver;
...
public class MCP3208App {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        console.title("<-- The Pi4J V2 Project Extension  -->", "MCP3208App");
...
//        MCP3208 spiCls = new MCP3208(pi4j, spiBus, chipSelect, pinCount, console, traceLevel, vref);
        ...
        Mcp3208Driver mcpDrv = new Mcp3208Driver(spi) ;
